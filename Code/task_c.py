...
plt.xlabel('Timestamp')
plt.ylabel('Power')
plt.title('RNN - True vs Predicted')
plt.grid()
plt.tight_layout()
plt.legend()
...
models = ['LR', 'SVR', 'ANN', 'RNN']
rmse = [rmse_lr, rmse_svr, rmse_ann, rmse_rnn]
plt.bar(models, rmse, color=['skyblue', 'lightgreen', 'salmon', 'plum'])
plt.ylabel('RMSE')
plt.title('Model RMSE Comparison')
plt.savefig('Results/Task3/RootMeanSquaredError.png')
plt.close()
