...
lr_results.to_csv('../Results/Task3/Day-Ahead/ForecastTemplate3-LR.csv', index=False)
...
plt.legend()
plt.tight_layout()
plt.savefig('../Results/Task3/Day-Ahead/LR_Predicted.png')
plt.close()
...
svr_results.to_csv('../Results/Task3/Day-Ahead/ForecastTemplate3-SVR.csv', index=False)
...
plt.legend()
plt.tight_layout()
plt.savefig('../Results/Task3/Day-Ahead/SVR_Predicted.png')
plt.close()
...
ann_results.to_csv('../Results/Task3/Day-Ahead/ForecastTemplate3-ANN.csv', index=False)
...
plt.legend()
plt.tight_layout()
plt.savefig('../Results/Task3/Day-Ahead/ANN_Predicted.png')
plt.close()
...
rnn_results.to_csv('../Results/Task3/Day-Ahead/ForecastTemplate3-RNN.csv', index=False)
...
plt.legend()
plt.tight_layout()
plt.savefig('../Results/Task3/Day-Ahead/RNN_Predicted.png')
plt.close()
...
plt.grid()
plt.tight_layout()
plt.savefig('../Results/Task3/Day-Ahead/RMSE.png')
plt.close()